...
import log from "../assets/الانثور.png";
        ...
        <header className="w-full bg-white shadow-sm relative z-50 pt-10 ">
            <div className=" mx-auto px-4 ">
                ...
                <div className="md:hidden flex items-center justify-between h-16 mb-2 pb-12 pt-4">
                    ...
                    <div className="flex items-center gap-4 "  >
                        {user ? (
                            ...
                            <Link 
                                to="/login" 
                                className="text-[#4E5A3F] text-2xl"
                            >
                ...
                <div className="hidden md:flex items-center justify-between h-20 pb-7">
                    {/* الجانب الأيسر - البحث والسلة */}
                    <div className="flex items-center gap-8">
                        <button 
                            onClick={"#"}
                            className="text-[#4E5A3F] hover:text-[#d3ae27] text-3xl"
                        >
                    ...
                    <div className="flex items-center gap-4">
                        {user ? (
                            ...
                            <Link 
                                to="/login" 
                                className="text-[#4E5A3F] hover:text-[#d3ae27] text-3xl transition-colors"
                            >
                                <i className="ri-user-line"></i>
                            </Link>
                        )}
                ...
                <div className={`absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl shadow-xl transition-transform duration-300 ${isMobileMenuOpen ? 'translate-y-0' : 'translate-y-full'}`}>
                    <div className="px-6 py-6 flex flex-col items-center gap-4">
                        ...
                        <Link 
                            to="/shop" 
                            onClick={handleMobileMenuToggle}
                            className="w-full text-center py-4 px-6 font-medium text-xl text-[#4E5A3F] hover:bg-[#f8f8f8] rounded-lg transition-all duration-300"
                        >
                            المنتجات
                        </Link>
                        <Link 
                        ...
                        <button 
                            onClick={"#"}
                            className="w-full flex items-center justify-center gap-2 py-4 px-6 font-medium text-xl text-[#4E5A3F] hover:bg-[#f8f8f8] rounded-lg transition-all duration-300"
                        >
                            <i className="ri-search-line"></i>
                            بحث
                        </button>
